...
BACKEND_DIR="$ROOT_DIR/src/modifications/ml_based/jt_vae/vendor/mol_opt/main/jt_vae"
...
uv pip install torch rdkit numpy scipy tqdm
...
Export these variables before using JTVAEModifier:
  ...
  export JT_VAE_VOCAB_PATH=$BACKEND_DIR/data/zinc/vocab.txt
